...
CREATE TABLE IF NOT EXISTS floorheat_settings(Id INTEGER PRIMARY KEY AUTOINCREMENT, TargetTemperature REAL, TargetState TEXT);
INSERT OR IGNORE INTO floorheat_settings VALUES (1, 10.0, 'OFF');
